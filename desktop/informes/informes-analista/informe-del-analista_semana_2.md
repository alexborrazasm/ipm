...
Los eventos que han marcado nuestro aprendizaje han sido muchos pero el que sería realmente importantes es el siguiente, Alexandre demostró un gran liderazgo repartiendo las tareas y asegurándose de que todos los miembros del equipo supieran qué hacer, pero lo más importante fue la decisión de que cada integrante trabajara en cada una de las partes del código, esto reduciría nuestra eficiencia inicial pero terminaría haciendo que cada integrante comprendiera mejor el código final. Además también han habido otros eventos notorios como el desarrollo del calendario en "add expenses" que a pesar de no ser una tarea demasiado difícil de implementar, para nosotros, alumnos sin experiencia resultó ser todo un reto en un principio.
