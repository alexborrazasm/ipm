# Curso 25/26. Práctica 2. Interfaces gráficas para aplicaciones de dispositivos móviles
...
> 🚨 No conocer el contenido de este repositorio, README,
> enunciado, roles, ... conllevará una calificación de cero puntos.


## Miembros del equipo:

- Pérez Pértega, Nerea : NereaPP : nerea.ppertega : Facilitadora-Administradora
- García Figueroa, Daniel : gitdfigueroa : d.figueroa : Curador-Traductor
- Borrazás Mancebo, Alexandre : alexborrazasm : alexandre.bmancebo : Analista
