...
Los elementos están en el baseline.

    | Se usan elementos de los lenguajes que no están soportados por los principales navegadores.
	
	| Se usan elementos que están soportados en los principales navegadores, pero presentan bugs o no están activados por defecto.
	
	| Los elementos empleados están identificados como _baseline_.
